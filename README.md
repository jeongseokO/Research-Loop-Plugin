...
현재 패키지: **0.8.0**. 미팅의 할 일을 담당자·완료 기준·출처와 연결해 등록하고, 자기 주인에게 배정된 작업의 진행·막힘·결과를 기록합니다. 사람이 수락하고 최종 완료를 확인합니다. 시작 시 작은 요약과 작업 단계별 조회를 사용하며, 반복 polling이나 종료된 AI의 자동 실행은 하지 않습니다. 기존 프로젝트 작업 지침·검토·경량 조회·자원 제한은 유지합니다.
