...
현재 패키지: **0.5.0**. 정량 그래프용 공통 Matplotlib 스타일과 재사용 함수를 제공합니다. 흰 배경·연한 격자·파랑/주황 비교·한글 폰트 대체를 기본으로 하며, 축과 강조는 데이터에 맞게 정합니다. “최신화”의 범위 확인, 그림 밖 캡션, 권한·검토 규칙과 필요한 안내만 읽는 방식을 유지합니다.
...
- PNG·PDF·SVG와 원본 코드·데이터를 보관하고, 페이지 너비에서 가독성을 확인한 뒤 첨부합니다. 기존 연구 그림은 자동으로 교체하지 않습니다.
